...
def LinearModels_experiment(
    ...
    for scaler_name, scaler in scalers.items():
        ...
        for C in C_values:
            for penalty in penalty_list:
                model_name = f"Linear_C{C}_penalty{penalty}"
                print(f"[{scaler_name} + {model_name}] Training...")

                model_dir = os.path.join(output_dir, model_name)
                os.makedirs(model_dir, exist_ok=True)

                model = LinearModelClassifier(C=C, penalty=penalty, random_state=random_state)
                ...
                plt.plot([0, 1], [0, 1], 'k--')
                plt.title(f'ROC - {model_name} | {scaler_name}')
                plt.legend()
    ...
    print(f"\nLinear Models Experiment hoàn tất!")
    print(f"→ Best: C={results_df.iloc[0]['C']}, Scaler={results_df.iloc[0]['Scaler']}, ROC-AUC={results_df.iloc[0]['ROC-AUC']}")

    return results_df

if __name__ == "__main__":
  # Random Forest experiment on KFold = 5
  LinearModels_experiment(
    ...
    output_dir="../experiment_result/indian_liver_patient/Linear_Models/K_Fold_01",
    label_col="Result"
  )
  LinearModels_experiment(
    ...
    output_dir="../experiment_result/indian_liver_patient/Linear_Models/K_Fold_02",
    label_col="Result"
  )
  LinearModels_experiment(
    ...
    output_dir="../experiment_result/indian_liver_patient/Linear_Models/K_Fold_03",
    label_col="Result"
  )
  LinearModels_experiment(
    ...
    output_dir="../experiment_result/indian_liver_patient/Linear_Models/K_Fold_04",
    label_col="Result"
  )
  LinearModels_experiment(
    ...
    output_dir="../experiment_result/indian_liver_patient/Linear_Models/K_Fold_05",
    label_col="Result"
  )
  ...
  LinearModels_experiment(
      ...
      test_path="../Data/KFold_data/indian_liver_patient_test_k_fold_01.csv",
      output_dir="../experiment_result/indian_liver_patient/Linear_Models/K_Fold_01_SMOTE",
  ...
  LinearModels_experiment(
      ...
      test_path="../Data/KFold_data/indian_liver_patient_test_k_fold_02.csv",
      output_dir="../experiment_result/indian_liver_patient/Linear_Models/K_Fold_02_SMOTE",
      label_col="Result",   # bạn dùng "Result" chứ không phải "Dataset"
  )
  LinearModels_experiment(
      ...
      test_path="../Data/KFold_data/indian_liver_patient_test_k_fold_03.csv",
      output_dir="../experiment_result/indian_liver_patient/Linear_Models/K_Fold_03_SMOTE",
      label_col="Result",   # bạn dùng "Result" chứ không phải "Dataset"
  )
  LinearModels_experiment(
      ...
      test_path="../Data/KFold_data/indian_liver_patient_test_k_fold_04.csv",
      output_dir="../experiment_result/indian_liver_patient/Linear_Models/K_Fold_04_SMOTE",
      label_col="Result",   # bạn dùng "Result" chứ không phải "Dataset"
  )
  LinearModels_experiment(
      ...
      test_path="../Data/KFold_data/indian_liver_patient_test_k_fold_05.csv",
      output_dir="../experiment_result/indian_liver_patient/Linear_Models/K_Fold_05_SMOTE",
      label_col="Result",   # bạn dùng "Result" chứ không phải "Dataset"
  )
  ...
  LinearModels_experiment(
      ...
      output_dir="../experiment_result/liver_cirrhosis/Linear_Models/K_Fold_01",
      label_col="Stage",   
  )
  LinearModels_experiment(
      ...
      output_dir="../experiment_result/liver_cirrhosis/Linear_Models/K_Fold_02",
      label_col="Stage",   
  )
  LinearModels_experiment(
      ...
      output_dir="../experiment_result/liver_cirrhosis/Linear_Models/K_Fold_03",
      label_col="Stage",   
  )
  LinearModels_experiment(
      ...
      output_dir="../experiment_result/liver_cirrhosis/Linear_Models/K_Fold_04",
      label_col="Stage",   
  )
  LinearModels_experiment(
      ...
      output_dir="../experiment_result/liver_cirrhosis/Linear_Models/K_Fold_05",
      label_col="Stage",   
  )
  ...
  LinearModels_experiment(
      ...
      test_path="../Data/KFold_data/liver_cirrhosis_test_k_fold_01.csv",
      output_dir="../experiment_result/liver_cirrhosis/Linear_Models/K_Fold_01_SMOTE",
  ...
  LinearModels_experiment(
      ...
      test_path="../Data/KFold_data/liver_cirrhosis_test_k_fold_02.csv",
      output_dir="../experiment_result/liver_cirrhosis/Linear_Models/K_Fold_02_SMOTE",
      label_col="Stage",   # bạn dùng "Result" chứ không phải "Dataset"
  )
  LinearModels_experiment(
      ...
      test_path="../Data/KFold_data/liver_cirrhosis_test_k_fold_03.csv",
      output_dir="../experiment_result/liver_cirrhosis/Linear_Models/K_Fold_03_SMOTE",
      label_col="Stage",   # bạn dùng "Result" chứ không phải "Dataset"
  )
  LinearModels_experiment(
      ...
      test_path="../Data/KFold_data/liver_cirrhosis_test_k_fold_04.csv",
      output_dir="../experiment_result/liver_cirrhosis/Linear_Models/K_Fold_04_SMOTE",
      label_col="Stage",   # bạn dùng "Result" chứ không phải "Dataset"
  )
  LinearModels_experiment(
      ...
      test_path="../Data/KFold_data/liver_cirrhosis_test_k_fold_05.csv",
      output_dir="../experiment_result/liver_cirrhosis/Linear_Models/K_Fold_05_SMOTE",
      label_col="Stage",   # bạn dùng "Result" chứ không phải "Dataset"
  )
